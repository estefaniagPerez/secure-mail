...
public class EncryptSMIMETest {
  ...
  public void encryptMultiPart() {
    try {
      MimeBodyPart body =
          EncryptSMIMETest.encryptor.encryptMultiPart(
              EncryptSMIMETest.msg, EncryptSMIMETest.message);
      assertNotNull(body);
  ...
  public void encryptData() {
    try {
      MimeBodyPart body =
          EncryptSMIMETest.encryptor.encryptData(
              EncryptSMIMETest.bodyPart, EncryptSMIMETest.message);
      assertNotNull(body);
    } catch (EncryptMailException ex) {
      fail("Expected Exception: 'EncryptMailException'");
    } catch (Exception ex) {
